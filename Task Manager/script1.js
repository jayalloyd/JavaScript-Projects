  // 1. Get references to the DOM elements
        ...
        // 2. DATA: The tasks array now holds objects to track 'completed' status
        // Use 'let' so we can assign loaded data.
        let tasks = []; 
        ...
        function addTasks(){
            ...
            renderTasks();
            saveTasks(); // <--- NEW: Save after adding
        } 
        ...
        function removeTasks(taskTextToRemove) {
            ...
            renderTasks();
            saveTasks(); // <--- NEW: Save after removing
        }
        ...
        function toggleTask(taskTextToToggle) {
            ...
            renderTasks();
            saveTasks(); // <--- NEW: Save after toggling
        }
